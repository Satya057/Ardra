...
const PriceCard = ({
  ...
  return (
    <>
      <div className="p-5 rounded-lg bg-slate-50/5 ring-1 ring-slate-300 shadow-md shadow-slate-200 hover:scale-105 duration-300 transition-all cursor-pointer">
